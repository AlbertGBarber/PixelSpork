...
Example call: 
    TheaterChaseSL(mainSegments, CRGB::Red, CRGB::Green, 1, 2, 100)
...
class TheaterChaseSL : public EffectBasePS {
    public:
        TheaterChaseSL(SegmentSet &SegmentSet, CRGB Color, CRGB BgColor, uint8_t LitLength, uint8_t Spacing, uint16_t Rate);  
