...
//Example calls: 
    ...
    //RainSegLinePS(mainSegments, &pallet3, CRGB::Red, true, 10, 4, 1, 1, 5, 80, true);
    ...
    //RainSegLinePS(mainSegments, CRGB::Green, 0, false, 10, 4, 1, 3, 2, 4, true, true, false, false, false, 60, 40, false);
...
//Notes:
    ...
    //new values
class RainSegLinePS : public EffectBasePS {
    public:
        //constructor for pallet colors, no range options
        RainSegLinePS(SegmentSet &SegmentSet, palletPS *Pallet, CRGB BgColor, bool BgPrefill, uint8_t SpawnChance, 
        ...
        RainSegLinePS(SegmentSet &SegmentSet, CRGB Color, CRGB BgColor, bool BgPrefill, uint8_t SpawnChance, 
