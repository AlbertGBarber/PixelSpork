#include "Fire2012SegLinePS.h"

Fire2012SegLinePS::Fire2012SegLinePS(SegmentSet &SegmentSet, palletPS *Pallet, CRGB BgColor, uint8_t Cooling, uint8_t Sparking, bool Blend, uint16_t Rate, bool Direct):
