#ifndef FirefliesPS_h
#define FirefliesPS_h
...
//Example calls: 
    ...
    //FirefliesPS(mainSegments, CRGB(222, 144, 9), 15, 5, 2000, 3000, 3, 6, 80);
    ...
    //FirefliesPS(mainSegments, &pallet1, 5, 20, 3000, 4000, 6, 14, 70);
    ...
    //FirefliesPS(mainSegments, 2, 20, 5, 3000, 3000, 2, 5, 80);
...
class FirefliesPS : public EffectBasePS {
    public:
        //Constructor for effect with pallet
        FirefliesPS(SegmentSet &SegmentSet, palletPS *Pallet, uint8_t MaxNumFireflies, uint8_t SpawnChance, 
        ...
        FirefliesPS(SegmentSet &SegmentSet, uint8_t numColors, uint8_t MaxNumFireflies, uint8_t SpawnChance, 
                    uint16_t LifeBase, uint16_t LifeRange, uint16_t SpeedBase, uint16_t SpeedRange, uint16_t Rate); 

        //constructor for effect with single color
        //!!If using pre-build FastLED colors you need to pass them as CRGB( *color code* ) 
        FirefliesPS(SegmentSet &SegmentSet, CRGB Color, uint8_t MaxNumFireflies, uint8_t SpawnChance, 
                    uint16_t LifeBase, uint16_t LifeRange, uint16_t SpeedBase, uint16_t SpeedRange, uint16_t Rate);
