...
/* 
The effect mimics classic white incandescent Christmas lights that gently twinkle on/off. 
...
Functions:
    reset() -- Resets all the pixels to black, restarting the effect.
