#ifndef ParticlesPS_h
#define ParticlesPS_h
...
//Example calls: 
    ...
    //ParticlesPS(mainSegments, particleSet, &pallet, CRGB::Red);
    //Will animate the single particle as described above, placing it on a red background

    //ParticlesPS(mainSegments, &pallet3, 0, 3, 2, 60, 50, 1, 3, 2, 3, 0, 2, pallet3.length, true);
...
class ParticlesPS : public EffectBasePS {
    public:
        ...
        ParticlesPS(SegmentSet &SegmentSet, particleSetPS *ParticleSet, palletPS *Pallet, CRGB BgColor);
    ...
    private:
        ...
        void
            ...
            setTrailColor(uint16_t trailLedLocation, uint8_t trailPixelNum);
};
