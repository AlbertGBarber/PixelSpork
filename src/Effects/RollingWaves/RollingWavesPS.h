#ifndef RollingWavesPS_h
#define RollingWavesPS_h
...
//There is a version of this effect that takes less CPU power (RollingWavesFastPS)
...
class RollingWavesPS : public EffectBasePS {
    public:
        RollingWavesPS(SegmentSet &SegmentSet, patternPS *Pattern, palletPS *Pallet, CRGB BGColor, uint8_t GradLength, uint8_t TrailMode, uint8_t Spacing, uint16_t Rate); 

        RollingWavesPS(SegmentSet &SegmentSet, palletPS *Pallet, CRGB BGColor, uint8_t GradLength, uint8_t TrailMode, uint8_t Spacing, uint16_t Rate);

        RollingWavesPS(SegmentSet &SegmentSet, uint8_t NumColors, CRGB BGColor, uint8_t GradLength, uint8_t TrailMode, uint8_t Spacing, uint16_t Rate);
