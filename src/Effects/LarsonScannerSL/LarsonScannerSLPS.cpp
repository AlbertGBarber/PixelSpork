#include "LarsonScannerSLPS.h"

LarsonScannerSLPS::LarsonScannerSLPS(SegmentSet &SegmentSet, uint8_t ScanType, CRGB scanColor, CRGB BgColor, uint8_t EyeSize, uint8_t TrailLength, uint16_t Rate):
...
void LarsonScannerSLPS::setColorMode(uint8_t colorMode, bool bgColorMode){
    if(!bgColorMode){
...
void LarsonScannerSLPS::setBounce(bool newBounce){
    bounce = newBounce;
...
void LarsonScannerSLPS::setScanType(uint8_t newScanType){
...
void LarsonScannerSLPS::setTrailLength(uint8_t newTrailLength){
...
void LarsonScannerSLPS::setEyeSize(uint8_t newEyeSize){
    eyeSize = newEyeSize;
