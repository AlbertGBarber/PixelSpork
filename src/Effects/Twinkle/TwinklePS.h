...
Example call: 
    TwinklePS(mainSegments, CRGB::Red, CRGB::Blue, 2, 4, 4, 70);
    ...
    TwinklePS(mainSegments, &pallet1, 0, 3, 1, 6, 60);
    ...
    TwinklePS(mainSegments, 0, 4, 2, 2, 80);
...
class TwinklePS : public EffectBasePS {
    public:
        ...
        TwinklePS(SegmentSet &SegmentSet, palletPS *Pallet, CRGB BgColor, uint16_t NumPixels, uint8_t FadeInSteps, uint8_t FadeOutSteps, uint16_t Rate);  
        //Constructor for a using a single color
        TwinklePS(SegmentSet &SegmentSet, CRGB Color, CRGB BgColor, uint16_t NumPixels, uint8_t FadeInSteps, uint8_t FadeOutSteps, uint16_t Rate);
        //Constructor for choosing all colors at random
        TwinklePS(SegmentSet &SegmentSet, CRGB BgColor, uint16_t NumPixels, uint8_t FadeInSteps, uint8_t FadeOutSteps, uint16_t Rate);
