...
Example calls:
    ...
    PrideWPalSegLine2PS(ringSegments, 4, true, true, 80);
...
class PrideWPalSegLine2PS : public EffectBasePS {
    public:
        PrideWPalSegLine2PS(SegmentSet &SegmentSet, bool Direct, bool RandomBriInc, uint16_t Rate);

        PrideWPalSegLine2PS(SegmentSet &SegmentSet, palletPS *Pallet, bool Direct, bool RandomBriInc, uint16_t Rate);  

        PrideWPalSegLine2PS(SegmentSet &SegmentSet, uint8_t numColors, bool Direct, bool RandomBriInc, uint16_t Rate);

        PrideWPalSegLine2PS(SegmentSet &SegmentSet, palletPS *Pallet, bool Direct, uint8_t GradLength, 
