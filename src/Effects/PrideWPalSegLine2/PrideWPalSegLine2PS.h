#ifndef PrideWPalSegLine2PS_h
#define PrideWPalSegLine2PS_h
...
Example calls:
    PrideWPalSegLine2PS(mainSegments, true, false, 80);
    ...
    PrideWPalSegLine2PS(ringSegments, 4, false, true, 80);
    ...
    PrideWPalSegLine2PS(ringSegments, &pallet1, true, true, 80);
    Will do an effect using colors from pallet1
    The brightness waves will move with the colors
    The brightness wave values will be randomized, see init() for the ranges
    The effect updates at 80ms

    PrideWPalSegLine2PS(ringSegments, &pallet1, true, 20, 120, 250, 350, 20, 40, 3, 7, 60);
    Will do an effect using colors from pallet1
    The brightness waves will move with the colors
...
*/
class PrideWPalSegLine2PS : public EffectBasePS {
    public:
        //constructor for rainbow mode
        PrideWPalSegLine2PS(SegmentSet &SegmentSet, bool BriDirect, bool RandomBriInc, uint16_t Rate);

        //constructor for pallet input
        PrideWPalSegLine2PS(SegmentSet &SegmentSet, palletPS *Pallet, bool BriDirect, bool RandomBriInc, uint16_t Rate);  

        //constructor for making a random pallet
        PrideWPalSegLine2PS(SegmentSet &SegmentSet, uint8_t numColors, bool BriDirect, bool RandomBriInc, uint16_t Rate);

        //constructor with inputs for all main variables
        PrideWPalSegLine2PS(SegmentSet &SegmentSet, palletPS *Pallet, bool BriDirect, uint8_t GradLength, 
        ...
        uint16_t 
            ...
            briThetaFreq = 250; //203 //how long we spend transitioning through waves
