...
The maximium possible number of pixels that can be colored at one time is numTwinkles
...
Example call: 
    Twinkle2PS(mainSegments, CRGB::Red, CRGB::Blue, 12, 50, 3, 2, 4, 5, 70);
    ...
    Twinkle2PS(mainSegments, &pallet1, 0, 8, 100, 2, 0, 6, 0, 60);
    ...
    Twinkle2PS(mainSegments, 0, 12, 20, 2, 0, 2, 0, 80);
...
*/
class Twinkle2PS : public EffectBasePS {
    public:
        //Constructor for a full pallet effect
        Twinkle2PS(SegmentSet &SegmentSet, palletPS *Pallet, CRGB BgColor, uint16_t NumTwinkles, uint8_t SpawnChance, 
        ...
        Twinkle2PS(SegmentSet &SegmentSet, CRGB Color, CRGB BgColor, uint16_t NumTwinkles, uint8_t SpawnChance,
                   uint8_t FadeInSteps, uint8_t FadeInRange, uint8_t FadeOutSteps, uint8_t FadeOutRange, uint16_t Rate);
        
        //Constructor for choosing all colors at random
        Twinkle2PS(SegmentSet &SegmentSet, CRGB BgColor, uint16_t NumTwinkles, uint8_t SpawnChance, 
                   uint8_t FadeInSteps, uint8_t FadeInRange, uint8_t FadeOutSteps, uint8_t FadeOutRange, uint16_t Rate);
