#ifndef FirefliesSLPS_h
#define FirefliesSLPS_h
...
Example calls: 
    ...
    FirefliesSLPS(mainSegments, CRGB(222, 144, 9), 15, 5, 2000, 3000, 3, 6, 80);
...
class FirefliesSLPS : public EffectBasePS {
    public:
        ...
        FirefliesSLPS(SegmentSet &SegmentSet, CRGB Color, uint8_t MaxNumFireflies, uint8_t SpawnChance, 
                    uint16_t LifeBase, uint16_t LifeRange, uint16_t SpeedBase, uint16_t SpeedRange, uint16_t Rate);
