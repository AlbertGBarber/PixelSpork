...
ColorWavesPS::ColorWavesPS(SegmentSet &SegmentSet, palletPS *Pallet):
    segmentSet(SegmentSet), pallet(Pallet)
    {    
        init();
	}

ColorWavesPS::ColorWavesPS(SegmentSet &SegmentSet, uint8_t numColors):
