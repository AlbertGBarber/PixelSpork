...
Example calls:
    ...
    PrideWPalSegLinePS(ringSegments, 4, true, true, 80);
...
class PrideWPalSegLinePS : public EffectBasePS {
    public:
        PrideWPalSegLinePS(SegmentSet &SegmentSet, bool Direct, bool RandomBriInc, uint16_t Rate);

        PrideWPalSegLinePS(SegmentSet &SegmentSet, palletPS *Pallet, bool Direct, bool RandomBriInc, uint16_t Rate);  

        PrideWPalSegLinePS(SegmentSet &SegmentSet, uint8_t numColors, bool Direct, bool RandomBriInc, uint16_t Rate);

        PrideWPalSegLinePS(SegmentSet &SegmentSet, palletPS *Pallet, bool Direct, uint8_t GradLength, 
