...
PrideWPalSegLinePS::PrideWPalSegLinePS(SegmentSet &SegmentSet, bool BriDirect, bool RandomBriInc, uint16_t Rate):
...
PrideWPalSegLinePS::PrideWPalSegLinePS(SegmentSet &SegmentSet, palletPS *Pallet, bool BriDirect, bool RandomBriInc, uint16_t Rate):
...
PrideWPalSegLinePS::PrideWPalSegLinePS(SegmentSet &SegmentSet, uint8_t numColors, bool BriDirect, bool RandomBriInc, uint16_t Rate):
    segmentSet(SegmentSet), briDirect(BriDirect)
    {    
        prideMode = false; 
...
PrideWPalSegLinePS::PrideWPalSegLinePS(SegmentSet &SegmentSet, palletPS *Pallet, bool BriDirect, uint8_t GradLength, 
