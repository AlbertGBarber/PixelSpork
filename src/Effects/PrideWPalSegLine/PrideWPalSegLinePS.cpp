#include "PrideWPalSegLinePS.h"

//constructor for rainbow mode
PrideWPalSegLinePS::PrideWPalSegLinePS(SegmentSet &SegmentSet, bool Direct, bool RandomBriInc, uint16_t Rate):
...
PrideWPalSegLinePS::PrideWPalSegLinePS(SegmentSet &SegmentSet, palletPS *Pallet, bool Direct, bool RandomBriInc, uint16_t Rate):
    segmentSet(SegmentSet), pallet(Pallet), direct(Direct)
    {    
        prideMode = false; 
        init(RandomBriInc, Rate);
	}
...
PrideWPalSegLinePS::PrideWPalSegLinePS(SegmentSet &SegmentSet, uint8_t numColors, bool Direct, bool RandomBriInc, uint16_t Rate):
    segmentSet(SegmentSet), direct(Direct)
    {    
        prideMode = false; 
...
PrideWPalSegLinePS::PrideWPalSegLinePS(SegmentSet &SegmentSet, palletPS *Pallet, bool Direct, uint8_t GradLength, 
    ...
    segmentSet(SegmentSet), pallet(Pallet), direct(Direct), gradLength(GradLength), brightDepthMin(BrightDepthMin), 
...
PrideWPalSegLinePS::~PrideWPalSegLinePS(){
...
void PrideWPalSegLinePS::init(bool RandomBriInc, uint16_t Rate){
...
void PrideWPalSegLinePS::randomizeBriInc(uint8_t briThetaMinMin, uint8_t briThetaMinMax, 
...
void PrideWPalSegLinePS::randomizeBriFreq( uint16_t briFreqMin, uint16_t briFreqMax ){
...
void PrideWPalSegLinePS::update(){
    currentTime = millis();
