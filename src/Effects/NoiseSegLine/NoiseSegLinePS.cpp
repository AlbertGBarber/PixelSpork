#include "NoiseSegLinePS.h"

NoiseSegLinePS::NoiseSegLinePS(SegmentSet &SegmentSet, uint8_t numColors, uint16_t BlendSteps, uint16_t ScaleBase, uint16_t ScaleRange, uint16_t Speed,  uint16_t Rate):
...
NoiseSegLinePS::NoiseSegLinePS(SegmentSet &SegmentSet, palletPS *Pallet, uint16_t BlendSteps, uint16_t ScaleBase, uint16_t ScaleRange, uint16_t Speed, uint16_t Rate):
...
void NoiseSegLinePS::init(uint16_t Rate){
...
void NoiseSegLinePS::setupNoiseArray(){
...
void NoiseSegLinePS::fillnoise8() {
...
void NoiseSegLinePS::mapNoiseSegsWithPalette(){
