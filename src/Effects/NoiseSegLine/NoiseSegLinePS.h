...
//Example calls: 
    //NoiseSegLinePS(mainSegments, 4, 20, 20, 60, 10, 80);
    ...
    //NoiseSegLinePS(mainSegments, &pallet1, 40, 5, 95, 20, 80);
...
class NoiseSegLinePS : public EffectBasePS {
    public:
        ...
        NoiseSegLinePS(SegmentSet &SegmentSet, uint8_t numColors, uint16_t BlendSteps, uint16_t ScaleBase, uint16_t ScaleRange, uint16_t Speed, uint16_t Rate);

        NoiseSegLinePS(SegmentSet &SegmentSet, palletPS *Pallet, uint16_t BlendSteps, uint16_t ScaleBase, uint16_t ScaleRange, uint16_t Speed, uint16_t Rate); 
