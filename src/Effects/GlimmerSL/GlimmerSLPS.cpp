#include "GlimmerSLPS.h"

GlimmerSLPS::GlimmerSLPS(SegmentSet &SegmentSet, uint16_t NumGlims, CRGB GlimmerColor, CRGB BgColor, bool TwoPixelSets, uint8_t FadeSteps, uint16_t Rate):
...
GlimmerSLPS::GlimmerSLPS(SegmentSet &SegmentSet, uint16_t NumGlims, CRGB GlimmerColor, CRGB BgColor, bool TwoPixelSets, uint8_t FadeSteps, uint8_t FadeMin, uint8_t FadeMax, uint16_t Rate):
...
GlimmerSLPS::~GlimmerSLPS(){
    delete[] fadePixelLocs;
    delete[] totFadeSteps;
}

void GlimmerSLPS::init(CRGB GlimmerColor, CRGB BgColor, uint16_t Rate){
...
void GlimmerSLPS::setupPixelArray(){
...
void GlimmerSLPS::fillPixelArray(){
    step = 0;
...
void GlimmerSLPS::advancePixelArray(){
    for(uint16_t i = 0; i < numGlims; i++){
...
void GlimmerSLPS::setNumGlims(uint16_t newNumGlims){
...
void GlimmerSLPS::setTwoSets(bool newSetting){
