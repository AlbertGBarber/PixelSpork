#include "NoiseGradSegLinePS.h"

//Constructor with pallet
NoiseGradSegLinePS::NoiseGradSegLinePS(SegmentSet &SegmentSet, palletPS *Pallet, CRGB BgColor, uint16_t BlendStepsBase, 
...
NoiseGradSegLinePS::NoiseGradSegLinePS(SegmentSet &SegmentSet, uint8_t numColors, CRGB BgColor, uint16_t BlendStepsBase, 
                                       uint16_t BlendStepsRange, uint8_t PhaseScale, uint8_t FreqScale, uint8_t BriScale,
                                       uint16_t BlendRate, uint16_t Rate):
...
NoiseGradSegLinePS::~NoiseGradSegLinePS(){
    delete[] palletTemp.palletArr;
}

//Initializes core common varaibles
void NoiseGradSegLinePS::init(CRGB BgColor, uint16_t BlendRate, uint16_t Rate){
...
void NoiseGradSegLinePS::update(){
    currentTime = millis();
...
void NoiseGradSegLinePS::shiftBlendSteps(){
    if(blendSteps == blendStepsTarget){
