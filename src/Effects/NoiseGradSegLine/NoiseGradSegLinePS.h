#ifndef NoiseGradSegLinePS_h
#define NoiseGradSegLinePS_h
...
Example calls: 
    ...
    NoiseGradSegLinePS(ringSegments, numColors, 0, minBase, maxBase, 10, 20, 30, 5000, 80);
    ...
    NoiseGradSegLinePS(ringSegments, &pallet1, 0, 8, 16, 5, 20, 10, 3000, 80);
    NoiseGradSegLinePS.bgColorMode = 6;
...
*/
class NoiseGradSegLinePS : public EffectBasePS {
    public:
        //Constructor with pallet
        NoiseGradSegLinePS(SegmentSet &SegmentSet, palletPS *Pallet, CRGB BgColor, uint16_t BlendStepsBase, uint16_t BlendStepsRange,
        ...
        NoiseGradSegLinePS(SegmentSet &SegmentSet, uint8_t numColors, CRGB BgColor, uint16_t BlendStepsBase, uint16_t BlendStepsRange,
                           uint8_t PhaseScale, uint8_t FreqScale, uint8_t BriScale, uint16_t BlendRate, uint16_t Rate);
