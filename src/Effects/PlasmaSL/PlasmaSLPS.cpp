...
void PlasmaSLPS::init(uint16_t Rate){
...
void PlasmaSLPS::randomizeFreq(uint8_t freqMin, uint8_t freqMax){
...
void PlasmaSLPS::shiftPhase(uint8_t *phase, uint8_t *phaseTarget, int8_t *phaseStep, uint8_t phaseBase, uint8_t phaseRange){
