...
TwinkleFastSLPS::TwinkleFastSLPS(SegmentSet &SegmentSet, palettePS *Palette, uint16_t NumTwinkles, CRGB BgColor, bool Sparkle, uint8_t FadeOutRate, uint16_t Rate):
