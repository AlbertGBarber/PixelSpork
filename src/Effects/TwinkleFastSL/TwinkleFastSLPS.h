...
Like, TwinkleSLPS, the color of the pixels can be set to a single color, chosen randomly, or picked from a palette 
...
class TwinkleFastSLPS : public EffectBasePS {
    public:
        ...
        TwinkleFastSLPS(SegmentSet &SegmentSet, palettePS *Palette, uint16_t NumTwinkles, CRGB BgColor, bool Sparkle, uint8_t FadeOutRate, uint16_t Rate);  
