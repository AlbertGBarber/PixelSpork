...
Example calls: 
    ...
    RainSLPS(mainSegments, &palette3, CRGB::Red, true, 10, 4, 1, 1, 5, 80, true);
...
class RainSLPS : public EffectBasePS {
    public:
        ...
        RainSLPS(SegmentSet &SegmentSet, palettePS *Palette, CRGB BgColor, bool BgPrefill, uint8_t SpawnChance, 
