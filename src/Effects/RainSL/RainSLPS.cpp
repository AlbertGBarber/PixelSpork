...
RainSLPS::RainSLPS(SegmentSet &SegmentSet, palettePS *Palette, CRGB BgColor, bool BgPrefill, uint8_t SpawnChance, 
...
RainSLPS::RainSLPS(SegmentSet &SegmentSet, CRGB Color, CRGB BgColor, bool BgPrefill, uint8_t SpawnChance, 
                    uint8_t MaxNumDrops, uint16_t Size, uint8_t TrailType, uint8_t TrailSize, uint16_t Rate, bool Direct):
...
void RainSLPS::init(uint16_t Rate, CRGB BgColor){
...
void RainSLPS::setupDrops(uint8_t newMaxNumDrops){
...
void RainSLPS::setDropSpawnPos(particlePS *particlePtr){
...
void RainSLPS::moveParticle(particlePS *particlePtr) {
...
void RainSLPS::drawParticlePixel(uint16_t trailLedLocation, uint8_t trailPixelNum, uint8_t trailSize, uint8_t lineNum, bool bodyPixel){
...
uint16_t RainSLPS::getParticlePixelLoc(uint16_t trailLedLocation, uint8_t lineNum){
...
uint16_t RainSLPS::getTrailLedLoc(bool trailDirect, uint8_t trailPixelNum, uint16_t maxPosition) { 
...
void RainSLPS::spawnParticle(uint8_t particleIndex, uint8_t lineNum){
