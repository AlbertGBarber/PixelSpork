...
Example call: 
    ...
    TwinkleSLPS(mainSegments, &palette1, 0, 3, 1, 6, 60);
...
class TwinkleSLPS : public EffectBasePS {
    public:
        ...
        TwinkleSLPS(SegmentSet &SegmentSet, palettePS *Palette, CRGB BgColor, uint16_t numTwinkles, uint8_t FadeInSteps, uint8_t FadeOutSteps, uint16_t Rate);  
