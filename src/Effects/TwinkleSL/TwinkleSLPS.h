...
The color of the lines will be set to a single color, chosen randomly, of picked from a pallet 
...
Example call: 
    TwinkleSLPS(mainSegments, CRGB::Red, CRGB::Blue, 2, 4, 4, 70);
    ...
    TwinkleSLPS(mainSegments, &pallet1, 0, 3, 1, 6, 60);
    Will choose 3 lines each cycle to fade to/from colors choosen from the pallet, using a blank background,
    with 1 fade in and 6 fade out steps, at a rate of 60ms

    TwinkleSLPS(mainSegments, 0, 4, 2, 2, 80);
...
*/
class TwinkleSLPS : public EffectBasePS {
    public:
