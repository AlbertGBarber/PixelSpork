...
Example calls: 
    ...
    Fire2012SLPS(mainSegments, &firePallet, 0, 50, 90, true, 70, true);
...
class Fire2012SLPS : public EffectBasePS {
    public:
        Fire2012SLPS(SegmentSet &SegmentSet, palletPS *Pallet, CRGB BgColor, uint8_t Cooling, uint8_t Sparking, bool Blend, uint16_t Rate, bool Direct);  
