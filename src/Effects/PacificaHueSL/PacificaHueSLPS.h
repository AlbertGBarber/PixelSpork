...
Example calls: 
    PacificaHueSLPS(ringSegments, 40);
    ...
    PacificaHueSLPS(ringSegments, true, 130, 40);
    Sets addWhiteCaps to true and the hue to 130, updates at 40ms

    PacificaHueSLPS(ringSegments, true, 50, 500, 40);
...
*/
class PacificaHueSLPS : public EffectBasePS {
    public:
        //Normal constructor
        PacificaHueSLPS(SegmentSet &SegmentSet, uint16_t Rate);  

        //constructor with addWhiteCaps setting
        PacificaHueSLPS(SegmentSet &SegmentSet, bool AddWhiteCaps, uint8_t Hue, uint16_t Rate);

        //constructor with addWhiteCaps and hue rate settings
        //The hue will be the initial hue of the palette
        PacificaHueSLPS(SegmentSet &SegmentSet, bool AddWhiteCaps, uint8_t Hue, uint16_t HueRate, uint16_t Rate);
