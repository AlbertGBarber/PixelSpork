#ifndef NoiseWavesSegLinePS_h
#define NoiseWavesSegLinePS_h
...
Example calls: 
    ...
    NoiseWavesSegLinePS(ringSegments, 3, 0, 30, 10, 3, 80);
    ...
    NoiseWavesSegLinePS(ringSegments, &pallet1, 0, 10, 2, 10, 80);
...
*/
class NoiseWavesSegLinePS : public EffectBasePS {
    public:
        //Constructor with pallet
        NoiseWavesSegLinePS(SegmentSet &SegmentSet, palletPS *Pallet, CRGB BgColor, uint16_t BlendScale, uint8_t PhaseScale, uint8_t FreqScale, uint16_t Rate);  
        
        //Constructor with randomly generated pallet
        NoiseWavesSegLinePS(SegmentSet &SegmentSet, uint8_t numColors, CRGB BgColor, uint16_t BlendScale, uint8_t PhaseScale, uint8_t FreqScale, uint16_t Rate);
