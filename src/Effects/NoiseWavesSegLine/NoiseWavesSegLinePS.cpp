#include "NoiseWavesSegLinePS.h"

//Constructor with pallet
NoiseWavesSegLinePS::NoiseWavesSegLinePS(SegmentSet &SegmentSet, palletPS *Pallet, CRGB BgColor, uint16_t BlendScale, uint8_t PhaseScale, uint8_t FreqScale, uint16_t Rate):
...
NoiseWavesSegLinePS::NoiseWavesSegLinePS(SegmentSet &SegmentSet, uint8_t numColors, CRGB BgColor, uint16_t BlendScale, uint8_t PhaseScale, uint8_t FreqScale, uint16_t Rate):
...
NoiseWavesSegLinePS::~NoiseWavesSegLinePS(){
    delete[] palletTemp.palletArr;
}

//Initializes core common varaibles
void NoiseWavesSegLinePS::init(CRGB BgColor, uint16_t Rate){
...
void NoiseWavesSegLinePS::update(){
    currentTime = millis();
