#include "GradientCycleSLPS.h"

//constructor with pattern
GradientCycleSLPS::GradientCycleSLPS(SegmentSet &SegmentSet, patternPS *Pattern, palettePS *Palette, uint8_t GradLength, uint16_t Rate):
...
GradientCycleSLPS::GradientCycleSLPS(SegmentSet &SegmentSet, palettePS *Palette, uint8_t GradLength, uint16_t Rate):
...
GradientCycleSLPS::GradientCycleSLPS(SegmentSet &SegmentSet, uint8_t NumColors, uint8_t GradLength, uint16_t Rate):
...
GradientCycleSLPS::~GradientCycleSLPS(){
    delete[] paletteTemp.paletteArr;
    delete[] patternTemp.patternArr;
}

//inits core variables for the effect
void GradientCycleSLPS::init(uint16_t Rate){
...
void GradientCycleSLPS::setGradLength(uint8_t newGradLength){
...
//we need to change the totalCycleLength to match
void GradientCycleSLPS::setPattern(patternPS *newPattern){
    pattern = newPattern;
    setTotalEffectLength();
}
...
//{0, 1, 2, 3, 4}
void GradientCycleSLPS::setPaletteAsPattern(){
...
void GradientCycleSLPS::setTotalEffectLength(){
...
void GradientCycleSLPS::setnextColors(uint16_t lineNum){
