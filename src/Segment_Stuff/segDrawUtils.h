...
namespace segDrawUtils{
    void 
        ...
        drawSegLine(SegmentSet &segmentSet, uint16_t lineNum, const CRGB &color, uint8_t colorMode),
        drawSegLineSection(SegmentSet &segmentSet, uint16_t startSeg, uint16_t endSeg, uint16_t lineNum, const CRGB &color, uint8_t colorMode),
