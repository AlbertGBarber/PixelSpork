...
Setup, Running, and Resetting:
    ...
    *Note that I've specified the effArray to be size 2, and that in the EffectSet, 
    ...
    effectSet in the first array index. The second index is for our actuall effect. 
    ...
    as the effectSet starts/ends. (The fades run concurently with the effect, so the effect spends 4000ms at full brightness 
    (10000 - 3000 *2)
